...
with two arguments: 1) the name of the instrument, and 2) the directory where
the original (raw data) FITS files are stored.
...
.. literalinclude:: setup_filabres_0.yaml
   :linenos:
   :lineno-start: 1
...
- ``forced_classifications_file``: the name of an auxiliary YAML file that
  contains the images that have to be classified manually (explained below).
...
.. literalinclude:: ignored_images_0.yaml
   :linenos:
   :lineno-start: 1
...
.. literalinclude:: image_header_corrections_0.yaml
   :linenos:
   :lineno-start: 1
...
.. literalinclude:: forced_classifications_0.yaml
   :linenos:
   :lineno-start: 1

This file will be used to define the images that will be manually
classified.
